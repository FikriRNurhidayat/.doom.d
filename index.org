...
#+begin_src elisp :tangle ./lisp/fain-splash.el
...
Ketika kita menyalakan =mixed-pitch-mode=, akan terjadi inkonsistensi di dalam tampilan di dalam org mode. Karena bintang dan judul dari suatu tajuk ditampilkan dengan /variable pitch font/ yang mana memiliki panjang yang berbeda-beda.
