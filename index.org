...
Terakhir, =org-modern= tidak kompatibel dengan =org-indent-mode=, maka dari itu ada paket baru yang perlu saya instal, yaitu =org-modern-indent=.

#+begin_src elisp :tangle ./packages.el
;;(package! org-modern-indent :recipe (:host github :repo "jdtsmith/org-modern-indent"))
#+end_src

Lalu, kita aktifkan =org-modern-indent-mode= ketika menyalakan =org-indent-mode=.
