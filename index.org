...
*** Fungsi Tambahan
**** Fokus ke Tajuk Induk

#+begin_src elisp :tangle ./config.el :results none
...
**** Pindah ke Tajuk Berikutnya

Let's add new function that will go to the next sibling of the current heading. I will bind this function with ~C-l~.
